    ...
    <div class = 'body'>
        ...
        <div class = 'left'>
            ...
            <p class = 'left'> Well, to sum everything up, we are four broke
                ...
                The geniuses in this group is Sailendran, Darrel, Zaireen and Abdul. We created this online shop with our blood, sweat and tears.  Let's get to know the website more.
            </p>
        ...
        <div class = 'left'>
            ...
            <ol>
                ...
                <li class='list'> Dynamic display for products </li>
                <li class='list'> Dynamic page for each product </li>
                <li class='list'> A fake payment page </li>
